...
class Main_window:
    ...
    def make_text_frame(self):
        ...
        self.text = tk.Text(self.text_frame, undo=True, font=self.my_font, wrap="word")

        self.scroll_bar = tk.Scrollbar(
            self.text_frame, bg="#000000", width=20, jump=True, highlightcolor="#ffffff"
        )
        ...
        self.text.pack(
            side="right", ipadx=4, ipady=4, anchor="e", fill="both", expand=True
        )
    ...
    def make_menu_bar(self):
        ...
        self.file_menu.add_command(
            label=" Save as ", command=self.file_operation.saveAs
        )
        ...
        self.help_menu.add_command(
            label=" Help on this app  ", command=self.file_operation.help_on_app
        )
    ...
    def help_on_run(self):
        showinfo(
            "Run Option ",
            " You can run your python code from Run menu or by pressing the f5 key, please note that you can't stop the code from running in the editor ",
        )
    ...
    def add_btn_ribbon(self, name, cmd):
        ...
        self.buttons[-1].pack(padx=4, pady=4, ipadx=2, ipady=2, side="left")
    ...
    def make_a_ribbon(self):
        ...
        self.btns_dict = {
            "Open": self.file_operation.open,
            "New": self.file_operation.new,
            "Save": self.file_operation.save,
            "Run": self.file_operation.run,
        }
    ...
    def packup(self):
        ...
        self.ribbon_frame.pack(side="top", anchor="e", padx=4, pady=2, fill="x")
